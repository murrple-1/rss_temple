...
_field_configs = {
    "user": {
        ...
        "hasGoogleLogin": _FieldConfig(
            lambda context, db_obj: db_obj.google_login() is not None, False
        ),
        "hasFacebookLogin": _FieldConfig(
            lambda context, db_obj: db_obj.facebook_login() is not None, False
        ),
    },
    "usercategory": {
        "uuid": _FieldConfig(lambda context, db_obj: str(db_obj.uuid), True),
        ...
        "feedUuids": _FieldConfig(
            lambda context, db_obj: [str(feed.uuid) for feed in db_obj.feeds()], False
        ),
    },
    "feed": {
        "uuid": _FieldConfig(lambda context, db_obj: str(db_obj.uuid), True),
        ...
        "publishedAt": _FieldConfig(
            lambda context, db_obj: context.format_datetime(db_obj.published_at), False
        ),
        "updatedAt": _FieldConfig(
            lambda context, db_obj: context.format_datetime(db_obj.updated_at)
        ...
        "calculatedTitle": _FieldConfig(
            lambda context, db_obj: db_obj.custom_title
        ...
        "userCategoryUuids": _FieldConfig(
            lambda context, db_obj: [
                ...
                for user_category in db_obj.user_categories(context.request.user)
            ],
            False,
        ),
        "readCount": _FieldConfig(
            lambda context, db_obj: db_obj.read_count(context.request.user), False
        ),
        "unreadCount": _FieldConfig(
            lambda context, db_obj: db_obj.unread_count(context.request.user), False
        ),
    },
    "feedentry": {
        "uuid": _FieldConfig(lambda context, db_obj: str(db_obj.uuid), True),
        ...
        "createdAt": _FieldConfig(
            lambda context, db_obj: context.format_datetime(db_obj.created_at)
        ...
        "fromSubscription": _FieldConfig(
            lambda context, db_obj: db_obj.from_subscription(context.request.user),
            False,
        ),
        "isRead": _FieldConfig(
            lambda context, db_obj: db_obj.is_read(context.request.user), False
        ),
        "isFavorite": _FieldConfig(
            lambda context, db_obj: db_obj.is_favorite(context.request.user), False
        ),
