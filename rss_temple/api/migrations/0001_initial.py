# Generated by Django 2.1.7 on 2019-03-09 17:14
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('uuid', models.UUIDField(default=uuid.uuid4, primary_key=True, serialize=False)),
                ('status', models.IntegerField(choices=[(0, 'Not Started'), (1, 'Started'), (2, 'Finished')], default=0)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feed_subscription_progress_entry', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.FeedSubscriptionProgressEntry')),
            ],
        ),
        migrations.CreateModel(
            name='FeedTagMapping',
        ...
        migrations.AddField(
            ...
            name='user_category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.UserCategory'),
        ),
        migrations.AddField(
