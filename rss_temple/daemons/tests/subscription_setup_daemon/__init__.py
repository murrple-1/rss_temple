...
class DaemonTestCase(TestCase):
    ...
    @unittest.skipIf('SUBSCRIPTION_SETUP_DAEMON_TEST_DO_SUBSCRIPTION' not in os.environ and 'CI' not in os.environ, 'long test - skipped unless forced via SUBSCRIPTION_SETUP_DAEMON_TEST_DO_SUBSCRIPTION environment variable')
